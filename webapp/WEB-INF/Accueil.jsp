...
<h1 class="col-lg-4 mx-auto">Liste des enchères</h1>
	...
	<div class="row"> 
	<h2 class="col-lg-4"> Filtres </h2></div>
  <div class="row">
  
  	<form  action="${pageContext.request.contextPath}/AccueilRechercherParMotCle2"  method="get">
  <span>
      <input  name="motCle" class="form-control border-primary" type="text"  placeholder="le nom de l'article contient" >
    </span>
	...
	<div class="row">
	<form  action="${pageContext.request.contextPath}/AccueilRechercherParCategorie"  method="get">
